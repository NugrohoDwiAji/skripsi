        ...
        <div className="h-[450px] w-[350px] shadow-2xl px-7 py-10 flex flex-col ">
          ...
          <form action="" className="flex flex-col gap-3 ">
            <div className="flex flex-col gap-1">
              ...
              <input type="email" placeholder="Username" onChange={(e) => setdata({...data, email: e.target.value})} className="inset-4 h-8 rounded-sm bg-black/15 backdrop-blur-lg outline-none px-2 text-white"/>
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="">Password</label>
              <input type="password" placeholder="Password" onChange={(e) => setdata({...data, password: e.target.value})} className="inset-4 h-8 rounded-sm bg-black/15 backdrop-blur-lg outline-none px-2 text-white" />
            </div>
            <button className="bg-blue-900 px-5 py-2 rounded-lg mt-2 text-white w-fit hover:scale-105" onClick={handleSubmit}>Sign In</button>
          </form>
